...
final class Inventories
{
        ...
        $menu->setListener(function (InvMenuTransaction $transaction) use ($time): InvMenuTransactionResult {
            ...
            switch ($item) {
                case "&aKeyall":
                    ...
                    $embed->setFooter("kitmap Network");
                    $msg->addEmbed($embed);
                ...
                case "&9OpKeyall":
                    ...
                    Loader::getInstance()->getServer()->broadcastMessage(TE::colorize("&7█&3█&7██&3█&7██ &r&7[&2&lkitmap &l&3OPKYEALL&r&7]"));
                ...
                case "&5Pkgall":
                    ...
                    Loader::getInstance()->getServer()->broadcastMessage(TE::colorize("&7█&5█&7██&5█&7██ &r&7[&2&lkitmap &l&5PPALL&r&7]"));
        ...
        $menu->setListener(function (InvMenuTransaction $transaction) use ($time): InvMenuTransactionResult {
            ...
            switch ($item) {
                ...
                case "&4Eotw":
                    ...
                    Loader::getInstance()->getServer()->broadcastMessage(TE::colorize("&7█&4█&7██&7█&7██ &r&7[&2&lkitmap &l&4EOTW&r&7]"));
                ...
                case "&4Purge":
                    ...
                    Loader::getInstance()->getServer()->broadcastMessage(TE::colorize("&7█&4█&7██&4█&7██ &r&7[&2&lkitmap &l&4PURGE&r&7]"));
                ...
                case "&aFFA":
                    ...
                    Loader::getInstance()->getServer()->broadcastMessage(TE::colorize("&7█&a█&7██&7█&7██ &r&7[&2&lkitmap &l&aFFA&r&7]"));
    ...
    {
        $menu = InvMenu::create(InvMenu::TYPE_DOUBLE_CHEST);
        $menu->getInventory()->setItem(4, new kitmapPlus);
        $menu->getInventory()->setItem(11, new kitmap);
