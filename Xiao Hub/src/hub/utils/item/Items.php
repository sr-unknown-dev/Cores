...
final class Items
{
    ...
    public static function createItemKitOpOrganization(Player $player, Item $item, string $kitName): Item
    {
    ...
    {
        $vkit = Loader::getInstance()->getHandlerManager()->getvKitManager()->getvKit($vKitName);
