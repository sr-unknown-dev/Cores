...
class KitManagerOp
{
    ...
    public function __construct(){
        # Register kits
        foreach (Loader::getInstance()->getProvider()->getKitsOp() as $name => $data) {
        ...
        Loader::getInstance()->getServer()->getPluginManager()->registerEvents(new KitListenerOp(), Loader::getInstance());
    }
    ...
    {
        return Loader::getInstance()->getProvider()->getKitOpConfig()->get('organization');
    }
     ...
     * @return Kit|null
     */
    public function getKit(string $kitName): ?KitOp
    {
    ...
    {
        $this->kits[$kitName] = new KitOp($kitName, $nameFormat, $permission, $itemRepresentative, $items, $armor, $cooldown);
        ...
        if ($new) {
            ...
            Loader::getInstance()->getProvider()->getKitOpConfig()->set('organization', $organization);
            Loader::getInstance()->getProvider()->getKitOpConfig()->save();
        }
    }
