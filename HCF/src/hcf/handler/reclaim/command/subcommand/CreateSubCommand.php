...
class CreateSubCommand implements ReclaimSubCommand
{
    ...
    public function execute(CommandSender $sender, array $args): void
    {
        ...
        Loader::getInstance()->getHandlerManager()->getReclaimManager()->createReclaim($name, $permission, (int) $time, $contents);
        $sender->sendMessage(TextFormat::colorize('&aYou have created the reclaim ' . $name . ' successfully'));
        
        Loader::getInstance()->getHandlerManager()->getReclaimManager()->registerPermission($permission);
    }
}