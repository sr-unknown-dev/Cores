...
class Archer extends HCFClass
{
    ...
    public function handleDamage(EntityDamageEvent $event): void
    {
        ...
        if ($player instanceof Player) {
            ...
            // if (Loader::getInstance()->inTag($tag, $player->getName())) {
                $baseDamage = $event->getBaseDamage();
                $event->setBaseDamage($baseDamage + 0.25);
            }
        }
    }
    ...
    public function handleDamageByChildEntity(EntityDamageByChildEntityEvent $event): void
    {
        ...
        if ($entity instanceof Player && $damager instanceof Player) {
            ...
            if ($damager->getClass()->getTypeId() === HCFClass::ARCHER) {
                if (!$child instanceof Arrow)
                    return;
                    
                if ($entity->getClass() !== null && $entity->getClass()->getTypeId() === HCFClass::ARCHER) {
                ...
                $entity->setNameTag(TextFormat::colorize('&8[&5ArcherTag&8] ' . $entity->getName()));
    ...
    public function handleItemUse(PlayerItemUseEvent $event): void
    {
        ...
        if ($player instanceof Player) {
            ...
            if ($player->getClass()->getTypeId() === HCFClass::ARCHER) {
