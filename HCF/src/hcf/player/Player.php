...
use hcf\handler\kit\classes\ClassScoreboard;
...
class Player extends BasePlayer
{
    ...
    private function updateScoreboard(): void
    {
        ...
        # Class
        $classArcher = ClassScoreboard::isArcher($this->getName()) ? " §l§7×§r &l&fClass: &r&5Archer" : "";
        $classBard = ClassScoreboard::isBard($this->getName()) ? " §l§7×§r &l&fClass: &r&gBard" : "";
        $classRogue = ClassScoreboard::isRogue($this->getName()) ? " §l§7×§r &l&fClass: &r&7Rogue" : "";
        $classMage = ClassScoreboard::isMage($this->getName()) ? " §l§7×§r &l&fClass: &r&7Mague" : "";
        $classMiner = ClassScoreboard::isMiner($this->getName()) ? " §l§7×§r &l&fClass: &r&bMiner" : "";

        $lines[] = TextFormat::colorize('💋');
        $lines[] = TextFormat::colorize($classArcher);
        $lines[] = TextFormat::colorize($classBard);
        $lines[] = TextFormat::colorize($classRogue);
        $lines[] = TextFormat::colorize($classMage);
        $lines[] = TextFormat::colorize($classMiner);
        $lines[] = TextFormat::colorize('💋');
