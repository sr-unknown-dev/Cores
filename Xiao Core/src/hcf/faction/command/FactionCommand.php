...
use hcf\faction\command\subcommand\admin\DisbandAllSubCommand;
use hcf\faction\command\subcommand\admin\FactionAddDtrCommand;
...
use hcf\faction\command\subcommand\admin\FactionRemoveDtrCommand;
...
use hcf\faction\command\subcommand\UpgradesSubCommand;
...
class FactionCommand extends Command
{
    ...
    public function __construct()
    {
        ...
        $this->subCommands['camp'] = new CampSubCommand;
        ...
        $this->subCommands['adddtr'] = new FactionAddDtrCommand;
        $this->subCommands['addpoints'] = new FactionAddPointCommand;
        $this->subCommands['removedtr'] = new FactionRemoveDtrCommand;
        $this->subCommands['removepoints'] = new FactionRemovePointCommand;
        ...
        $this->subCommands['addstrike'] = new FactionAddStrikeCommand;
        $this->subCommands['removestrike'] = new FactionRemoveStrikeCommand;
