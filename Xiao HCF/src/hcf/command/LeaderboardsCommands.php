...
class LeaderboardsCommands extends Command
{
    ...
    {
        if (!isset($args[0])) {
            $sender->sendMessage(TextFormat::colorize('&3» &7Use /leaderboards &f[kills/kdr/deaths]'));
            return;
        }
        ...
        if (strtolower($args[0]) === 'kills') {
            if (!isset($args[1])) {
                ...
                $sender->sendMessage(TextFormat::colorize('&l&3Leaderboard Kills'));
        ...
        if (strtolower($args[0]) === 'kdr') {
            if (!isset($args[1])) {
                ...
                $sender->sendMessage(TextFormat::colorize('&l&3Leaderboard KDR'));
        ...
        if (strtolower($args[0]) === 'deaths') {
            if (!isset($args[1])) {
                ...
                $sender->sendMessage(TextFormat::colorize('&l&3Leaderboard Deaths'));
